...
## This repository contains a collection of Administrative tasks of Linux based Systems.  These Projects are more focused on HOW-Tos rather than WHAT's in it. Each project includes documentation, screenshots, and working configurations. If Documentation followed, its easier to do daily boring tasks and reference it later. This project will continue to have new projects as I keep uploading them. 
---
